...
const adminMenus: string[] = [
  ...
  MENU_IDS.CONTACTS,
  MENU_IDS.CONTACTS_CHAT,
  MENU_IDS.CONTACTS_FILES,
  // 智能体
  MENU_IDS.AI,
  MENU_IDS.AI_MODELS,
  MENU_IDS.AI_AGENTS,
  MENU_IDS.AI_API_KEYS,
  MENU_IDS.AI_MCP_SERVERS,
  MENU_IDS.AI_USER_MEMORY,
  // 服务器监控
  MENU_IDS.MONITOR,
  MENU_IDS.MONITOR_OVERVIEW,
  MENU_IDS.MONITOR_CHARTS,
  MENU_IDS.MONITOR_PROCESSES,
  MENU_IDS.MONITOR_PORTS,
  // 系统管理（部分）
  MENU_IDS.SYSTEM,
  MENU_IDS.USERS,
  MENU_IDS.ROLES,
