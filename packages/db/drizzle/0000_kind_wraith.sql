...
CREATE TABLE "ai_model" (
	...
	"support_thinking" boolean DEFAULT false NOT NULL,
	"support_prefix_completion" boolean DEFAULT false NOT NULL,
	"support_fim" boolean DEFAULT false NOT NULL,
	"support_json_output" boolean DEFAULT false NOT NULL,
	"support_image_input" boolean DEFAULT false NOT NULL,
	"support_video_input" boolean DEFAULT false NOT NULL,
	"support_audio_input" boolean DEFAULT false NOT NULL,
	"support_image_output" boolean DEFAULT false NOT NULL,
	"support_video_output" boolean DEFAULT false NOT NULL,
	"support_audio_output" boolean DEFAULT false NOT NULL,
	...
	"cache_hit_price_per_million" numeric(10, 4),
	"cache_miss_price_per_million" numeric(10, 4)
);
--> statement-breakpoint
CREATE TABLE "ai_provider" (
	...
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"name" varchar(64) NOT NULL,
	"provider_type" varchar(32) DEFAULT 'openai-compatible' NOT NULL,
...
CREATE INDEX "idx_user_memory_expire" ON "ai_user_memory" USING btree ("expire_at");--> statement-breakpoint
