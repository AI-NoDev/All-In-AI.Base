/**
 * AI提供商模块 Schema 定义 (TypeBox)
 */

import { t } from 'elysia';

// Re-export from entity for convenience
export { providerSchemas, type ProviderSelect, type ProviderInsert } from '@qiyu-allinai/db/entities/ai/provider';

/** 提供商过滤条件 Schema */
export const providerFilterSchema = t.Optional(t.Object({
  ids: t.Optional(t.Array(t.String({ description: '提供商ID' }), { description: '按ID列表精确匹配' })),
  names: t.Optional(t.Array(t.String({ description: '提供商名称' }), { description: '按名称列表精确匹配' })),
...
/** 排序 Schema */
export const providerSortSchema = t.Optional(t.Object({
...
/** 分页查询请求体 Schema */
export const providerPaginationBodySchema = t.Object({
