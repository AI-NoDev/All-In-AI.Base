...
const app = new Elysia()
  .get('/schema', createActionHandler(messageGetSchema))
  .post('/query', createActionHandler(messageGetByPagination))
  .get('/:id', createActionHandler(messageGetByPk))
  .post('/', createActionHandler(messageCreate))
  .put('/:id/recall', createActionHandler(messageRecall));

const api = treaty(app);

describe('Message Actions', () => {
  describe('messageGetSchema', () => {
  ...
  describe.skipIf(!process.env.DATABASE_URL)('需要数据库', () => {
    it('messageGetByPagination', async () => {
    ...
    it('messageGetByPk - not found', async () => {
