...
import { generateText, streamText, Output, type ModelMessage, type StopCondition, type ToolSet, type StepResult } from 'ai';
...
export const stream = <TOOLS extends ToolSet, O extends ZodObjectShape = ZodObjectShape>(
