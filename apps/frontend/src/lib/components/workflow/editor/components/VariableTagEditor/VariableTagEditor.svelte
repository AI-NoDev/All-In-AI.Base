<script lang="ts">
	...
	import { VariableSelectorList } from '../VariableSelector/index';
	import type { Variable } from '../VariableSelector/types';
	import { parseContent, createVariableTag } from './types';
	...
	function renderToEditor() {
		...
		const editor = editorRef; // Capture reference for use in callbacks
