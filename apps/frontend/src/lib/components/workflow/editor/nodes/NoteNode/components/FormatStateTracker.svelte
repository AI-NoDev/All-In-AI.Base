<script lang="ts">
	...
	import type { LexicalNode } from './lexical-utils';
	...
	function updateFormatState() {
		...
		// Cast through unknown to avoid complex type overlap issues with Lexical internals
		const sel = selection as unknown as SelectionWithFormat;
